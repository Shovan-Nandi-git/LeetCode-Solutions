...
| LC18        | 4Sum                               | Medium     | Sorting + Two Pointers                 |
| LC31        | Next Permutation                   | Medium     | Greedy + Reverse Suffix                |
| LC56        | Merge Intervals                    | Medium     | Sorting + Interval Merging             |
| LC74        | Search a 2D Matrix                 | Medium     | Binary Search                          |
...
| Problem No. | Problem Name        | Difficulty | Approach                     |
| ----------- | ------------------- | ---------- | ---------------------------- |
| LC147       | Insertion Sort List | Medium     | Linked List + Insertion Sort |
